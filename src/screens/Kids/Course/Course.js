    ...
    return (
        ...
        <View style={styles.container1}>
            ...
            <View style={styles.listExtension}>
                ...
                <TouchableOpacity  onPress={() => navigation.navigate('CourseStudying')}style={{alignItems: 'center', justifyContent: 'center', borderRadius: 100, borderWidth: 0.2, backgroundColor: '#e83640', height: '50%', width: '50%', flex: 0.6}}>
            ...
            <View style={styles.listCourse}>
                <View style={{flex: 1}}>
                    <ScrollView >
                        <Text style={{ color: '#000000', marginLeft: 20, fontSize: 15 , marginTop: 20}}>Có thể bé sẽ thích! </Text>
                        {
                                ...
                                return (
                                    <View style={{ flex: 1, marginBottom: 20, marginLeft: 20, marginTop: 20, flexDirection: 'row' }} key={index}>
                                        <View style={{flex: 1, alignItems: 'flex-start'}}>
                                            <TouchableOpacity onPress={() => navigation.navigate('RecommendCourses', { course_id: index })}>
