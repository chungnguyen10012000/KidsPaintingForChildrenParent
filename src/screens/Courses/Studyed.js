...
export default function StudyedScreen({ navigation }) {
    ...
    return (
        ...
        <View style={styles.container1}>
            <View style={styles.header}>
                <Text style={{ color: '#ffffff', fontSize: 20, marginLeft: 20, textAlign: 'left', fontWeight: 'bold' }}>Danh sách</Text>
            </View>
                                ...
                                return (
                                    <View style={{ flex: 1, marginBottom: 20, marginLeft: 20, marginTop: 20, flexDirection: 'row' }} key={index}>
                                        <View style={{flex: 1, alignItems: 'flex-start'}}>
                                            <TouchableOpacity onPress={() => navigation.navigate('ViewResultStudyed', { course_id: index })}>
                                        ...
                                        <View style={{flex: 2}}>
                                            ...
                                            <Text style={{ textAlign: 'left', alignContent: 'center', alignItems: 'center' }}>Thời gian: 10 tháng trước </Text>
