...
export default function DetailContestScreen({ route, navigation }) {
                ...
                function () {
                    return (
                        <View style={styles.content}>
                            <Text style={{ textAlign: 'center', alignItems: 'center', margin: 20, color:'#3DB2FF'}}>Chi tiết cuộc thi: {contestList[contest_id].ContestBody}</Text>
                            <Text style={{ }}>Loại: Chì màu</Text>
                            <Text style={{ }}>Câp độ: Trẻ 5-9 tuổi</Text>
                            <Text style={{ }}>Trạng thái:  {contestList[contest_id].ContestStatus}</Text>
                            <Text style={{ }}>Thời gian bắt đầu:  {contestList[contest_id].StartTime}</Text>
                            <Text style={{ }}>Thời gian kết thúc:  {contestList[contest_id].EndTime}</Text>
                        </View>
                    )
                }
            )()
