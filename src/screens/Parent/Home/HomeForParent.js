...
export default function HomeForParent({ route, navigation }) {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.listExtension}>
                ...
                <TouchableOpacity  onPress={() => navigation.navigate('AddAccountKid')}style={{alignItems: 'center', justifyContent: 'center', borderRadius: 100, borderWidth: 0.2, backgroundColor: '#e83640', height: '50%', width: '50%', flex: 0.6}}>
                ...
                <View style={{flex: 1, alignItems: 'center', justifyContent: 'center', }}>
                <TouchableOpacity onPress={() => navigation.navigate('ShoppingCart')} style={{alignItems: 'center', justifyContent: 'center',borderRadius: 100, borderWidth: 0.2, backgroundColor: '#fdbf00', height: '50%', width: '50%', flex: 0.6}}>
                ...
                <View style={{flex: 1, alignItems: 'center', justifyContent: 'center', }}>
                <TouchableOpacity onPress={() => navigation.navigate('HistoryPayment')} style={{alignItems: 'center', justifyContent: 'center',borderRadius: 100, borderWidth: 0.2, backgroundColor: '#fdbf00', height: '50%', width: '50%', flex: 0.6}}>
