...
export default function StartScreen_0({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={{ marginLeft: 20, fontSize: 20 }}>Chương trình học vẽ bài bản</Text>
            </View>
            <View style={styles.content}>
                <Text style={{ marginLeft: 20, marginRight: 20 }}>
                    Các lớp học của Kids Painting được thiết kế theo các cấp độ từ cơ bản đến nâng cao, phù hợp với lứa tuổi của học viên, nội dung giáo trình có chiều sâu và bài bản cả ở mảng hội họa lẫn tính ứng dụng của mỹ thuật trong cuộc sống cùng đội ngũ giáo viên chuyên nghiệp.
                </Text>
            </View>
